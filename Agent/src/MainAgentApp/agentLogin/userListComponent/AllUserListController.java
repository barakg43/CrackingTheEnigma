package MainAgentApp.agentLogin.userListComponent;
...
public class AllUserListController implements Closeable {
    ...
    private Consumer<UserListDTO> userListDTOConsumer;
    @FXML
    ...
    private void updateTableView(UserListDTO allUserList)
    {
        if(allUserList!=null)
            Platform.runLater(()->{
                userListDTOConsumer.accept(allUserList);
    ...
    public void setUserListDTOConsumer(Consumer<UserListDTO> userListDTOConsumer) {
        this.userListDTOConsumer = userListDTOConsumer;
    }
}
