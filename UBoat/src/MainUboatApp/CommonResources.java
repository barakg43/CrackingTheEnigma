...
public class CommonResources {
    ...
    public final static String UBOAT_MAIN_APP_FXML_LOGIN = "MainUboatApp/MainUboat.fxml";
    public final static String UBOAT_APP_FXML_LOGIN = "Login/login.fxml";

    public final static String UBOAT_APP_FXML_INCLUDE_RESOURCE = "UBoatApp/UboutTab.fxml";
    public static final String TEAM_DATA_SINGLE_TILE =  "ContestTab/SingleTeamData/singleTeamData.fxml";
    ...
    public static final String CANDIDATE_SINGLE_TILE = "ContestTab/TeamsStatus/SingleTeamData/singleTeamData.fxml";
