...
import static general.ApplicationType.AGENT;


@WebServlet(name = "LoginServlet", urlPatterns = {"/login/agent"})
                ...
                synchronized (this) {
                    if (userManager.isUserExists(usernameFromParameter)) {
                       response.getOutputStream().print("Username " + usernameFromParameter + " already exists. Please enter a different username.");
                        ...
                        userManager.addUserName(usernameFromParameter, ApplicationType.valueOf(typeUserNameFromParameter));
