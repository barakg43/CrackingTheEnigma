...
@WebServlet(name = "NewGuestServlet", urlPatterns = "/guestslist/new")
public class GuestIntroductionServlet extends HttpServlet {

    private static final String GUEST_NAME_PARAMETER = "guest";
    public static final String GUESTS_LIST_PROPERTY_NAME = "guestsList";
...
//    private List<String> guestsList;
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try (PrintWriter out = resp.getWriter()) {
            String guestName = req.getParameter(GUEST_NAME_PARAMETER);
